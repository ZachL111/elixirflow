...
elixirflow is a Elixir project for data pipelines. It focuses on this technical goal: Model bounded backpressure and retryable pipeline stages.
...
The core module exposes a small scoring API. Inputs are simple numeric signals: demand, capacity, latency, risk, and weight. The score uses a threshold of 164, risk penalty 7, latency penalty 4, and weight bonus 6. Tests exercise the public API against the fixture cases in `fixtures/cases.csv`.
