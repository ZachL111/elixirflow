"""Regression checks for the elixirflow casebook."""
...
from casebook.harness import assert_expected, elixirflow_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(elixirflow_summary(), assert_expected())
